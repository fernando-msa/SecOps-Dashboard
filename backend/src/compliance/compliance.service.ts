...
import { ComplianceCheck, ComplianceFramework, ComplianceStatus } from "./compliance-check.entity";
  ...
  async getSummary(tenantId: string) {
    ...
    return frameworks.map((framework) => {
      ...
      return {
        ...
        partial: frameworkChecks.filter((c) => c.status === ComplianceStatus.PARTIAL)
          .length,
