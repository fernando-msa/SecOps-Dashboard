...
import { SecurityEvent, EventStatus } from "../security-events/security-event.entity";
import { Vulnerability } from "../vulnerabilities/vulnerability.entity";
import { ComplianceCheck, ComplianceStatus } from "../compliance/compliance-check.entity";
...
export class MetricsService {
  ...
  async getMTTR(tenantId: string) {
    ...
    if (resolvedEvents.length === 0) return { mttr: 0, unit: "hours", sampleSize: 0 };
