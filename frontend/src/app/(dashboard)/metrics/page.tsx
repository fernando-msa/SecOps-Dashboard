  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-gray-500">Security performance indicators</p>
      </div>
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-xs text-gray-400">
                {mttr?.sampleSize || 0} resolved events
              </p>
            </div>
          </div>
        </Card>
        ...
        <Card>
          <div className="flex items-center gap-4">
            ...
            <div>
              <p className="text-sm text-gray-500">MTTD</p>
              <p className="text-2xl font-bold text-gray-900">
                {mttd?.mttd || 0}h
              </p>
              <p className="text-xs text-gray-400">
                {mttd?.sampleSize || 0} detected events
              </p>
            </div>
          </div>
        </Card>
